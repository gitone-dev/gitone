 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Diffs($fullPath: String!, $after: String, $leftRevision: String, $rightRevision: String!) {\n  repository(fullPath: $fullPath) {\n    id\n    diffs(\n      first: 20\n      after: $after\n      leftRevision: $leftRevision\n      rightRevision: $rightRevision\n    ) {\n      edges {\n        node {\n          ...DiffFragment\n        }\n        cursor\n      }\n      pageInfo {\n        ...PageInfoFragment\n      }\n    }\n  }\n}"): (typeof documents)["query Diffs($fullPath: String!, $after: String, $leftRevision: String, $rightRevision: String!) {\n  repository(fullPath: $fullPath) {\n    id\n    diffs(\n      first: 20\n      after: $after\n      leftRevision: $leftRevision\n      rightRevision: $rightRevision\n    ) {\n      edges {\n        node {\n          ...DiffFragment\n        }\n        cursor\n      }\n      pageInfo {\n        ...PageInfoFragment\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */

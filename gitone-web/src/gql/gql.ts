 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Diff($fullPath: String!, $oldRevision: String, $newRevision: String!) {\n  repository(fullPath: $fullPath) {\n    id\n    diffs(oldRevision: $oldRevision, newRevision: $newRevision) {\n      edges {\n        node {\n          id\n          oldSha\n          newSha\n          oldPath\n          newPath\n          changeType\n          diff\n        }\n        cursor\n      }\n    }\n  }\n}"): (typeof documents)["query Diff($fullPath: String!, $oldRevision: String, $newRevision: String!) {\n  repository(fullPath: $fullPath) {\n    id\n    diffs(oldRevision: $oldRevision, newRevision: $newRevision) {\n      edges {\n        node {\n          id\n          oldSha\n          newSha\n          oldPath\n          newPath\n          changeType\n          diff\n        }\n        cursor\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */

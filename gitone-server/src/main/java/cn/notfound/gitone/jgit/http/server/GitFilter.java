...
package cn.notfound.gitone.jgit.http.server;

import cn.notfound.gitone.jgit.http.server.glue.ErrorServlet;
import cn.notfound.gitone.jgit.http.server.glue.MetaFilter;
import cn.notfound.gitone.jgit.http.server.glue.RegexGroupFilter;
import cn.notfound.gitone.jgit.http.server.glue.ServletBinder;
import cn.notfound.gitone.jgit.http.server.resolver.AsIsFileService;
import cn.notfound.gitone.jgit.http.server.resolver.DefaultReceivePackFactory;
import cn.notfound.gitone.jgit.http.server.resolver.DefaultUploadPackFactory;
 ...
 * {@link cn.notfound.gitone.jgit.http.server.GitServlet}.
 * <p>
 * Applications may wish to add additional repository action URLs to this
 * servlet by taking advantage of its extension from
 * {@link cn.notfound.gitone.jgit.http.server.glue.MetaFilter}. Callers may register
...
public class GitFilter extends MetaFilter {
	 ...
	 *            {@link cn.notfound.gitone.jgit.http.server.ServletUtils#ATTRIBUTE_HANDLER}.
	 */

...
package cn.notfound.gitone.jgit.http.server.glue;

import cn.notfound.gitone.jgit.http.server.HttpServerText;
...
public class MetaFilter implements Filter {
	static final String REGEX_GROUPS = "cn.notfound.gitone.jgit.http.server.glue.MetaServlet.serveRegex";

...
class ReceivePackServlet extends HttpServlet {
	...
	static class InfoRefs extends SmartServiceInfoRefs {
		...
		InfoRefs(ReceivePackFactory<HttpServletRequest> receivePackFactory,
				List<Filter> filters) {
			super(GitSmartHttpTools.RECEIVE_PACK, filters);
	...
	public void doPost(final HttpServletRequest req,
		...
		if (!GitSmartHttpTools.RECEIVE_PACK_REQUEST_TYPE.equals(req.getContentType())) {
		...
		rsp.setContentType(GitSmartHttpTools.RECEIVE_PACK_RESULT_TYPE);
